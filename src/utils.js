...
// Nota: a função de conversão/"máscara" de detalhes de pagamento foi removida.
// A aplicação agora exibe `detalhes_pagamentos` originais e escolhe formas
// diretamente onde necessário sem sobrescrever os dados importados.